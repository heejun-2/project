						...
						<div id="main-box2">
							<div>
								<div id="table-div">
									 ...
									 int noticeNoInt = 0;
									 if(noticeNo != null) noticeNoInt = Integer.parseInt(noticeNo);
									 
									 noticeDao dao = new noticeDao();
									 Notice n = new Notice(noticeNoInt);
									 
									 for(Notice sch : dao.getListNotice(n)){
									 %>
									 	<tr>
									 		<th>제목</th><td colspan="5"><%=sch.getTitle() %></td>
									 	</tr>
										<tr>
											<th>작성자</th><td>관리자</td><th>조회수</th><td width="200px"><%=sch.getViews() %></td><th>작성일</th><td width="200px"><%=sch.getNoticeDate() %></td>
										</tr>
										<tr><td colspan="6" style="text-align:left; height:450px"><%=sch.getContents() %></td></tr>
									<%} %>
									 </table>
