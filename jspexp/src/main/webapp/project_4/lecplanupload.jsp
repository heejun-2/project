...
<%
String loc="C:\\Users\\ghktk\\git\\project\\jspexp\\src\\main\\webapp\\project_4\\a01_upload";
...
%>
 ...
 <jsp:useBean id="dao" class="dao.eduDao"/>
 <jsp:useBean id="sch" class="vo.lectureVO"/>
